<script setup>
  import { ref } from 'vue';
  import { StdIoRequests } from '../../../server/events/mapping/StdIoEventMapping.js';
  ...
  const aliases = {
    'echo'    : StdIoRequests.REQUEST_ECHO,
    'restart' : StdIoRequests.REQUEST_RESTART,
  }
